...
use lib qw( ../bindings/perl-shared/blib/lib ../bindings/perl-shared/blib/arch /data/openshift/5335fc54d561c1410e000001/app-root/runtime/build-dependencies/rrdtool/lib/perl );
